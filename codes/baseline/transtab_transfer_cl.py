...
parser.add_argument("--dataset", type=str, default="nnstocks", help="Task dataset family.")
parser.add_argument("--table_idx", type=int, default=0, help="Task table index.")
parser.add_argument("--aux_dataset", type=str, default="nnstocks", help="Auxiliary dataset family.")
