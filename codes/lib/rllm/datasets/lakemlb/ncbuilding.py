...
class NCBuildingDataset(Dataset):
    ...
    table scenarios in Data Lake(House) settings, as collected in the LakeMLB
    Data Lake Machine Learning Benchmark.
    ...
    def download(self):
        extract_local_archive(
            "ncbuilding", "union", self.raw_dir, self.raw_filenames
        )
