...
class MSTrafficSeattleDataset(Dataset):
    ...
    def __init__(self, cached_dir: str, force_reload: Optional[bool] = False,
                 transform=None, device=None, tokenizer_config=None
                 ) -> None:
        ...
        self.data_list: List[TableData] = [TableData.load(self.processed_paths[0])]
